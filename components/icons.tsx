export function IconTelegram({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M21.5 4.5 3.1 11.2c-1.5.5-1.5 1.2-.3 1.7l4.6 1.4 1.8 5.5c.2.6.1.8.6.8.5 0 .7-.2 1-.6l2.4-2.3 5 3.7c.9.5 1.6.2 1.8-.7l3.5-16.5c.3-1.2-.4-1.7-1.4-1.3ZM17 7.6l-9.3 8.6c-.2.2-.4.7.1.8l2.5.8c.5.2.5.5.6.9l.4 2.7c0 .3.1.4.3.4s.3-.1.4-.3l2-1.9 4.2 3.1c.8.4 1.3.2 1.5-.6l2.7-12.6Z" />
    </svg>
  );
}
...
export function IconTruck({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M14 18V6a2 2 0 0 0-2-2H4v14h2" />
...
export function IconSuitcase({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
